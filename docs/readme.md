...
you can have a look in the [ideas sub directory](ideas/).

## Usage
at some point you will find some [user documentation in `usage`](usage/)

---
# License
dual license under MIT License (see [LICENSE file](../LICENSE))
and CC-BY
